...
class Db_manager_tournament:
    ...
    def _get_players_by_tournament_id(self, tournament_id: int) -> dict:
        ...
        """
        tournament_document = self.tournaments_table.get(doc_id=tournament_id)
        player_dict = {}
        if tournament_document:
            player_dict = tournament_document.get('players')
            if player_dict:
                return player_dict
        return {}
    ...
    def get_one_from_db(self, tournament_id: int):
        ...
        if tournament_document:
            ...
            if tournament_obj:
                ...
                tournament_players_dict = tournament_document["players"]
    ...
    def get_rounds_by_tournament_id(self, tournament_id: int) -> list[Round] | list:
        ...
        tournament_document = self.tournaments_table.get(doc_id=tournament_id)
        if tournament_document:
            rounds_db_list = tournament_document["rounds"]
    ...
    def update_players_by_tournament_id(self, tournament):
    ...
    def update_round_quantity_by_tournament_id(self, tournament):
    ...
    def update_status_by_tournament_id(self, tournament):
    ...
    def add_one(self, tournament) -> bool | int:
        ...
        if not self.tournaments_table.search(
            ...
            tournament_document = self.tournaments_table.get(
                (
                    tournament.name == tournament_dict["name"]
                ) & (
                    tournament.date == tournament_dict["date"]
            ...
            if tournament_document:
                tournament_id = tournament_document.doc_id
                return tournament_id
        # This never append
        return False

    def update_rounds_by_tournament_id(self, tournament):
